...
const getSavesDefault = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (likedQuery === "true") {
            ...
            const likedRecords = yield Like.find({ userId }).select("itemId").lean();
        ...
        const totalCount = yield KeyBinding.countDocuments(findCriteria);
        // Find key bindings for the specific user.
        const savedData = yield KeyBinding.find(findCriteria)
        ...
        const savedDataWithLikes = yield Promise.all(savedData.map((save) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const likesCount = yield Like.countDocuments({ itemId: save._id });
...
const getItemData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const itemData = yield KeyBinding.find({ _id: itemId, userId: req.session.userId });
...
const deleteItemProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const deletedItem = yield KeyBinding.findOneAndDelete({
            _id: deleteId,
